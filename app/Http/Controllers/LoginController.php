...
class LoginController extends Controller
{
    ...
    public function ad_taotk(Request $request){
         $rules = [
            'email' =>'required|email',
            'password' => 'required|min:6|confirmed'
        ];
        ...
        if ($validator->fails()) {
            ...
            if($count>0){
                ...
                return redirect()->route('ad_xemcb',$id)->with(['flag2'=>'danger','message'=>'Tạo thành khoản thành công, mời cập nhật thông tin cán bộ']);
